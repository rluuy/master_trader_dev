    ...
    <div className="bg-black min-h-screen flex flex-col items-center justify-center p-10 pt-24 relative overflow-hidden">
      ...
      <section className="mb-12">
        ...
        <div className="bg-[#16162F] p-6 rounded-lg">
            <h3 className="text-xl font-medium text-gray-300 mb-2">Knowledgeable Senator</h3>
            <p className="text-gray-600 mb-2">"Wall Street's Favorite Grandmother"</p>
...
If you're looking for investment advice backed by experience and allegedly impeccable timing, Knowledgeable Senator is your go-to stock guru.
          ...
          <div className="bg-[#16162F] p-6 rounded-lg">
            ...
            <p className="text-gray-600 mb-2">"Make Wall Street Great Again""</p>
            <div className="text-center">
          ...
          <div className="bg-[#16162F] p-6 rounded-lg">
            ...
            <p className="text-gray-600 mb-2">"Hands in Pocket"</p>
            <div className="text-center">
          ...
          <div className="bg-[#16162F] p-6 rounded-lg">
            ...
            <p className="text-gray-600 mb-2">"Eller Silver Cohort"</p>
            <div className="text-center">
          ...
          <div className="bg-[#16162F] p-6 rounded-lg">
            ...
            <p className="text-gray-600 mb-2">"BAWK"</p>
            <div className="text-center">
